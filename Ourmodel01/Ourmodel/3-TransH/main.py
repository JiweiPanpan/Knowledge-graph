...
if __name__ == '__main__':
    ...
    if True:
        ...
        for epoch in range(num_epochs):
            ...
            for i, bidx in enumerate(train_loader):
                ...
                positive_score = kge_model.score(head, relation, tail, head_w, relation_w, tail_w, 'training')
                negative_score_tail = kge_model.score(head, relation, tail_neg, head_w, relation_w, tail_w, 'training')
                negative_score_head = kge_model.score(head_neg, relation, tail, head_w, relation_w, tail_w, 'training')
    ...
    if True:
        ...
        mean_rank, hits10 = ranking(head, relation, tail, head_t_w, relation_t_w, tail_t_w, ent_num, kge_model)
